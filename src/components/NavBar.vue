    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        ...
        <ul class="navbar-nav  mb-2 mb-lg-0 d-flex nav-respons" style="align-items: baseline">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#">
              <font-awesome-icon :icon="['fas', 'bell']" class="font-icon" />
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#">
        ...
        <div class="nav-profile">
          <div class="img-containar">
            <img src="../assets/images/avatar.webp" class="" alt="">
          </div>
          <div>
            <!-- <h5>Majd Ahmed</h5> -->
            <ul class="navbar-nav">
...
<script setup>
import ToggelBtn from "@/components/ToggelBtn.vue";
</script>
