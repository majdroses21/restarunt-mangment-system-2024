        ...
        <div class="modal-body">
          <form @click.prevent>
            <div class="container">
              ...
              <span class="validate-style" v-if="v$.name.$error">
              ...
              <span class="validate-style" v-if="v$.price.$error">
              ...
              <div class="input-container">
                ...
                <div class="form-floating mb-3">
                  <input
                    type="number"
                    id="flotNumInp"
                    placeholder="Enter Item Quantitie"
                    name="num"
                    v-model="state.num"
                    class="form-control"
                  />
              ...
              <span class="validate-style" v-if="v$.num.$error">
                {{ v$.num.$errors[0].$message }}</span
              >
              ...
              <span class="validate-style" v-if="v$.desc.$error">
              ...
              <div class="input-container">
                ...
                <div class="form-floating mb-3">
                  <select
                    id="flotSlect"
                    class="form-select"
                    v-model="state.pickedCaty"
                    name="pickedCaty"
                  >
                    <option>Open This Select Menue</option>
                    <option
                      v-for="(cat, i) in st.listOfCategorys"
                      :key="i"
                      :value="cat.id"
                    >
                      {{ cat.name }}
              ...
              <span class="validate-style" v-if="v$.pickedCaty.$error">
                {{ v$.pickedCaty.$errors[0].$message }}</span
              >
          ...
          <div class="alert alert-success" v-if="successMessege.length > 0">
            {{ successMessege }}
          </div>
        </div>
...
console.log("your userId is: ", userId.value);
...
onMounted(async () => {
  ...
  store.dispatch("doDisplayAllCategorys", {
    userId: userId.value,
